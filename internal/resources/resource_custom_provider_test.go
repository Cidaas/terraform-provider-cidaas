		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					// default value check
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.family_name.ext_field_key", "cp_family_name"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.address.ext_field_key", "cp_address"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.birthdate.ext_field_key", "01-01-2000"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.email.ext_field_key", "cp@cidaas.de"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.email_verified.ext_field_key", "email_verified"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.gender.ext_field_key", "male"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.given_name.ext_field_key", "cp_given_name"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.locale.ext_field_key", "cp_locale"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.middle_name.ext_field_key", "cp_middle_name"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.mobile_number.ext_field_key", "100000000"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.phone_number.ext_field_key", "10000000"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.picture.ext_field_key", "https://cidaas.de/image.jpg"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.preferred_username.ext_field_key", "cp_preferred_username"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.profile.ext_field_key", "cp_profile"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.updated_at.ext_field_key", "01-01-01"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.website.ext_field_key", "https://cidaas.de"),
					resource.TestCheckResourceAttr(resourceCustomProvider, "userinfo_fields.zoneinfo.ext_field_key", "cp_zone_info"),
