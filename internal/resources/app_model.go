...
func updateStateModel(res cidaas.AppResponse, state, config *AppConfig, operation int) diag.Diagnostics { //nolint:gocognit
	...
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.CompanyName, &config.CompanyName, &state.CompanyName, "CompanyName", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.CompanyWebsite, &config.CompanyWebsite, &state.CompanyWebsite, "CompanyWebsite", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.ClientType, &config.ClientType, &state.ClientType, "ClientType", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.CompanyAddress, &config.CompanyAddress, &state.CompanyAddress, "CompanyAddress", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.AccentColor, &config.AccentColor, &state.AccentColor, "AccentColor", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.PrimaryColor, &config.PrimaryColor, &state.PrimaryColor, "PrimaryColor", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.MediaType, &config.MediaType, &state.MediaType, "MediaType", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.HostedPageGroup, &config.HostedPageGroup, &state.HostedPageGroup, "HostedPageGroup", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.TemplateGroupID, &config.TemplateGroupID, &state.TemplateGroupID, "TemplateGroupID", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.LogoAlign, &config.LogoAlign, &state.LogoAlign, "LogoAlign", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.Webfinger, &config.Webfinger, &state.Webfinger, "Webfinger", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.ContentAlign, &config.ContentAlign, &state.ContentAlign, "ContentAlign", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.ClientName, &config.ClientName, &state.ClientName, "ClientName", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.ClientDisplayName, &config.ClientDisplayName, &state.ClientDisplayName, "ClientDisplayName", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.PolicyURI, &config.PolicyURI, &state.PolicyURI, "PolicyURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.TosURI, &config.TosURI, &state.TosURI, "TosURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.ImprintURI, &config.ImprintURI, &state.ImprintURI, "ImprintURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.TokenEndpointAuthMethod, &config.TokenEndpointAuthMethod, &state.TokenEndpointAuthMethod, "TokenEndpointAuthMethod", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.TokenEndpointAuthSigningAlg, &config.TokenEndpointAuthSigningAlg, &state.TokenEndpointAuthSigningAlg, "TokenEndpointAuthSigningAlg", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.CaptchaRef, &config.CaptchaRef, &state.CaptchaRef, "CaptchaRef", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.CommunicationMediumVerification, &config.CommunicationMediumVerification, &state.CommunicationMediumVerification, "CommunicationMediumVerification", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.BackchannelLogoutURI, &config.BackchannelLogoutURI, &state.BackchannelLogoutURI, "BackchannelLogoutURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.LogoURI, &config.LogoURI, &state.LogoURI, "LogoURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.InitiateLoginURI, &config.InitiateLoginURI, &state.InitiateLoginURI, "InitiateLoginURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.RegistrationClientURI, &config.RegistrationClientURI, &state.RegistrationClientURI, "RegistrationClientURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.RegistrationAccessToken, &config.RegistrationAccessToken, &state.RegistrationAccessToken, "RegistrationAccessToken", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.ClientURI, &config.ClientURI, &state.ClientURI, "ClientURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.JwksURI, &config.JwksURI, &state.JwksURI, "JwksURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.Jwks, &config.Jwks, &state.Jwks, "Jwks", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.SectorIdentifierURI, &config.SectorIdentifierURI, &state.SectorIdentifierURI, "SectorIdentifierURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.SubjectType, &config.SubjectType, &state.SubjectType, "SubjectType", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.IDTokenSignedResponseAlg, &config.IDTokenSignedResponseAlg, &state.IDTokenSignedResponseAlg, "IDTokenSignedResponseAlg", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.IDTokenEncryptedResponseAlg, &config.IDTokenEncryptedResponseAlg, &state.IDTokenEncryptedResponseAlg, "IDTokenEncryptedResponseAlg", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.IDTokenEncryptedResponseEnc, &config.IDTokenEncryptedResponseEnc, &state.IDTokenEncryptedResponseEnc, "IDTokenEncryptedResponseEnc", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.UserinfoSignedResponseAlg, &config.UserinfoSignedResponseAlg, &state.UserinfoSignedResponseAlg, "UserinfoSignedResponseAlg", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.UserinfoEncryptedResponseAlg, &config.UserinfoEncryptedResponseAlg, &state.UserinfoEncryptedResponseAlg, "UserinfoEncryptedResponseAlg", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.UserinfoEncryptedResponseEnc, &config.UserinfoEncryptedResponseEnc, &state.UserinfoEncryptedResponseEnc, "UserinfoEncryptedResponseEnc", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.RequestObjectSigningAlg, &config.RequestObjectSigningAlg, &state.RequestObjectSigningAlg, "RequestObjectSigningAlg", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.RequestObjectEncryptionAlg, &config.RequestObjectEncryptionAlg, &state.RequestObjectEncryptionAlg, "RequestObjectEncryptionAlg", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.RequestObjectEncryptionEnc, &config.RequestObjectEncryptionEnc, &state.RequestObjectEncryptionEnc, "RequestObjectEncryptionEnc", operation)...)
	...
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.ConsentPageGroup, &config.ConsentPageGroup, &state.ConsentPageGroup, "ConsentPageGroup", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.PasswordPolicyRef, &config.PasswordPolicyRef, &state.PasswordPolicyRef, "PasswordPolicyRef", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.BlockingMechanismRef, &config.BlockingMechanismRef, &state.BlockingMechanismRef, "BlockingMechanismRef", operation)...)
	...
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.MfaConfiguration, &config.MfaConfiguration, &state.MfaConfiguration, "MfaConfiguration", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.BackgroundURI, &config.BackgroundURI, &state.BackgroundURI, "BackgroundURI", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.VideoURL, &config.VideoURL, &state.VideoURL, "VideoURL", operation)...)
	diags.Append(StringValueOrNullWithPlanValue(&res.Data.BotCaptchaRef, &config.BotCaptchaRef, &state.BotCaptchaRef, "BotCaptchaRef", operation)...)
